            ...
            <div class="card-venda-premium ${venda.status}">
                ...
                <div class="venda-financeiro">
                    ...
                    <div style="display:flex; gap:8px; justify-content: flex-end; margin-top:10px;">
                        <button onclick="abrirModalEditarVenda('${venda.id}', '${venda.descricao}', ${venda.valor}, '${venda.status}', '${venda.conta_id || ''}')" class="btn-acao" style="color: var(--cor-primaria);" title="Editar">
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (filtroContaVendas) {
        ...
        filtroContaVendas.addEventListener("change", carregarVendas);
    }
